...
// 	Restore(ctx context.Context, tx pgx.Tx, id core.Id, restorer core.Restorer) error
// 	Store(ctx context.Context, tx pgx.Tx, storer core.Storer) error
// }
...
// 		return err
// 	}
// 	aggregate.Restore(id, version, func(state core.StatePtr) {
...
// 	persister := r.findPersister(aggregate)
// 	return aggregate.Store(func(id core.Id, state core.StatePtr, events core.EventPack, version core.Version) error {
